...
public class EditarEstabActivity extends VegAdvisorActivity implements DialogInterface.OnClickListener, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_editar_estab);
                    ...
                    case 147: /*Actualizacion de establecimiento*/
                        ...
                        if (Constants.ONE.equals(result.getValidationInd())) {/*Exitoso*/
                            ...
                            if (estabImagesFiles.size() == 0) {/*Sin imagenes*/
                                ...
                                Intent intent = new Intent(EditarEstabActivity.this, MenuPrincipalActivity.class);
                                //Navega
            ...
            public void run() {
                ...
                switch (serviceId) {
                    ...
                    case 144:/*Busqueda de paises*/
                        ...
                        //Array Adapter
                        adapter = new ArrayAdapter<Object>(EditarEstabActivity.this,
     ...
     */
        ...
        googleMap.setOnMapLongClickListener(new GoogleMap.OnMapLongClickListener() {
            ...
            public void onMapLongClick(LatLng latLng) {
                ...
                new AlertDialog.Builder(EditarEstabActivity.this).setTitle(R.string.seleccionar_ubicacion)
                        .setPositiveButton(R.string.aceptar, EditarEstabActivity.this)
